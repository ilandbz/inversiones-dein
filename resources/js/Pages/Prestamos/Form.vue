              ...
              <div class="card-body">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-12 col-md-4">
                    ...
                    <input v-model.trim="form.dondepagara" class="form-control" placeholder="Ej: AGENTE / YAPE / CAJA" />
                  </div>

                  <div class="col-12 col-md-8">
                    <label class="form-label">Fuente de recursos</label>
                    <input v-model.trim="form.fuenterecursos" class="form-control"
                      :class="{ 'is-invalid': hasError('fuenterecursos') }"
                      placeholder="Ej: SUELDO / NEGOCIO / VENTAS / OTROS"
                      @input="clearFieldError('fuenterecursos')" />
                    <div class="invalid-feedback" v-if="hasError('fuenterecursos')">{{ firstError('fuenterecursos') }}</div>
                  </div>
                </div>
